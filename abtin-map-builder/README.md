...
build_abm.py
  ...
  └─ routing/graph_builder.py     routing/graph.sqlite (گره‌ها، یال‌ها، نام جاده، junction، محدودیت‌های گردش)
...
build_abm.py
  ...
  └─ routing/graph_builder.py     routing/graph.sqlite (nodes, edges, road metadata, turn restrictions)
