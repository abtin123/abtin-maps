...
enum NavKey { settings, voice, home, routes, search }
  ...
  void _onTap(NavKey key) {
    ...
    switch (key) {
      case NavKey.home:
        ...
        break;
      case NavKey.routes:
        context.go('/routes'); // Changed to go to ensure correct Nav state
        break;
      case NavKey.search:
        context.push('/search');
        break;
                ...
                child: BackdropFilter(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: AppColors.subGlassBgSoft(context).withOpacity(0.8),
                      border: const Border(
                ...
                child: BackdropFilter(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: AppColors.subGlassBorder(context), width: 1),
                    ),
                  ),
                ),
              ),
