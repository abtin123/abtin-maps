                ...
                data: (places) {
                  if (places.isEmpty) {
                    return Column(
                      ...
                      children: [
                        const Text('هنوز مکانی ذخیره نکرده‌اید', style: TextStyle(color: AppColors.textSecondary)),
  ...
  void _confirmDeleteCategory(BuildContext context, WidgetRef ref, List<SavedPlace> places) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('همه‌ی ${places.length} مکان این دسته حذف شود؟', style: const TextStyle(color: AppColors.textSecondary)),
        actions: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text('$count مکان', style: const TextStyle(color: AppColors.textSecondary, fontSize: 13)),
            ],
          ),
        ),
