...
class _VoiceSettingsScreenState extends ConsumerState<VoiceSettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final isModelMissing = voiceService.isModelMissing;
    final isDownloading = voiceService.isDownloading;
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (engine == VoiceEngine.tts && isModelMissing)
                        Container(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: isDownloading ? null : () async {
                                  await voiceService.downloadModels();
                                  setState(() {});
                                },
                                ...
                                child: Text(isDownloading ? 'در حال نصب...' : 'نصب خودکار مدل‌ها'),
                              ),
                            ],
                          ),
                        ),
