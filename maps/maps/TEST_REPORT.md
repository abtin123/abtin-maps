...
- Zoom contract: PASS — vector source range is z2 through z16 with app overzoom to z18
- Day/night style contract: PASS — source z2-z16, POI z12, buildings z14, major roads z8, local roads z14
- Synthetic `.abm` pack + strict container verifier: PASS
  - graph segment embedded
  - vector PMTiles data embedded
  - offline FTS5 search index embedded and queried
  - day/night styles/glyphs/sprites verified as app-bundled renderer assets
