#!/usr/bin/env python3
"""Validate an ABTINMAP v3 graph segment created by build_abm_graph.py."""
...
def main() -> None:
    ...
    with args.graph.open("rb") as handle:
        ...
        if version < 3 or not (5 <= zoom <= 14) or tile_count == 0:
        ...
        previous_tile = 0
        previous_end = 0
        data_base = strings_offset + strings_comp
        for _ in range(tile_count):
            ...
            relative_offset = previous_end + delta_offset
            ...
            previous_end = relative_offset + compressed_length
    print(
