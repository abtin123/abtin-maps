...
The PMTiles payload remains the first declared tile-data region; only routing graph and offline search are appended to the ABM. Rendering styles, glyphs and POI sprites are app-bundled and are intentionally not duplicated in every map.
