...
def build_container(args: argparse.Namespace) -> None:
    ...
    metadata["abtin_container"] = {
        ...
        "contracts": {"pmtiles_maxzoom": 16, "poi_minzoom": 12, "building_minzoom": 14, "major_road_label_minzoom": 8, "local_road_label_minzoom": 14, "offline_search": "search/places.sqlite"},
        "graph": graph_info,
        "entries": entries,
    }
