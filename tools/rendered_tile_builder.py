...
def main():
    ...
    parser.add_argument("--max-open-tiles", type=int, default=256,
    ...
    try:
        ...
        # یک عبور PBF به‌جای سه عبور جدا برای لایه‌های ساختمان، راه و POI.
        RenderHandler(store).apply_file(source, locations=True)
