...
patch_builder = (root / "server_map_builder/tools/abtinmap_diff.py").read_text(encoding="utf-8")
...
abm_service = (root / "lib/abtinmap/abm_map_service.dart").read_text(encoding="utf-8")
assert "_downloadAndApplyPatch" in abm_service
assert "ABTINMAP-CHUNK-PATCH/1" in abm_service
